...
export default function JavaScriptTutorialPage() {
  const course = javascriptTutorial;
        ...
        <main className="min-w-0 flex-1">
          ...
          >
            <div className="max-w-[760px]">
              <div className="tab mb-4">Frontend JavaScript</div>
              ...
              {first && (
                <Link href={`/tutorials/javascript/${first.slug}`} className="btn btn-primary">
                  ...
                  <div key={section.id}>
                    ...
                    <ol className="overflow-hidden rounded-xl border" style={{ borderColor: 'var(--line)' }}>
                      {section.lessons.map((lesson, idx) => (
                        ...
                        >
                          <Link
                            href={`/tutorials/javascript/${lesson.slug}`}
                          ...
                          >
                            <div className="flex min-w-0 items-start gap-3">
                              ...
                              <div className="min-w-0">
                                <div className="truncate font-medium text-[15px]">{lesson.title}</div>
